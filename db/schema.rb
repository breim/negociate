...
ActiveRecord::Schema.define(version: 20140415015616) do
  ...
  add_index "collectors", ["cpf"], name: "index_collectors_on_cpf", unique: true, using: :btree
  ...
  create_table "debts", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.decimal  "valordojuros",   precision: 8, scale: 2
    t.decimal  "valorapagardia", precision: 8, scale: 2
  end
